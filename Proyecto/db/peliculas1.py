...
# Guardar la información en un archivo JSON en el formato adecuado para MongoDB
with open('peliculas_mongodb.json', 'w', encoding='utf-8') as file:
    json.dump(peliculas, file)

print("La información de las películas se ha guardado en el archivo 'peliculas_mongodb.json' en el formato adecuado para MongoDB.")
